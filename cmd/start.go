...
import (
	...
	"github.com/infraboard/demo/api"
	...
	// 加载所有服务
	_ "github.com/infraboard/demo/pkg/all"
)
...
func init() {
	...
	serviceCmd.Flags().StringVarP(&confFile, "config-file", "f", "etc/demo.toml", "the service config from file")
